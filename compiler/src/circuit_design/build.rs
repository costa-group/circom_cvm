...
fn build_template_instances(
    ...
    for template in ti {
        ...
        let code_info = CodeInfo {
            ...
            in_function: false,
            in_function_returning_array: false
        };
...
fn build_function_instances(
    ...
    for instance in instances {
        ...
        let code_info = CodeInfo {
            ...
            constraint_assert_dissabled_flag, 
            in_function: true,
            in_function_returning_array: is_array_result
        };
...
fn initialize_cvm_producer(vcp: &VCP, database: &TemplateDB, cvm_multi_assign_flag: bool, version: &str) -> CVMProducer {
