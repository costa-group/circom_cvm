...
pub fn constant_i64(value: &str) -> CVTInstruction {
    format!("i64.const {}", value)
}
pub fn constant_ff(value: &str) -> CVTInstruction {
    format!("ff.const {}", value)
}

pub fn add64() -> CVTInstruction {
    "i64.add".to_string()
}
pub fn addff() -> CVTInstruction {
    "ff.add".to_string()
}
pub fn sub64() -> CVTInstruction {
    "i64.sub".to_string()
}
pub fn subff() -> CVTInstruction {
    "ff.sub".to_string()
}
pub fn mul64() -> CVTInstruction {
    "i64.mul".to_string()
}
pub fn mulff() -> CVTInstruction {
    "ff.mul".to_string()
}
pub fn div64() -> CVTInstruction {
    "i64.div".to_string()
}
pub fn rem64() -> CVTInstruction {
    "i64.rem".to_string()
}
pub fn idivff() -> CVTInstruction {
    "ff.idiv".to_string()
}
pub fn divff() -> CVTInstruction {
    "ff.div".to_string()
}
pub fn remff() -> CVTInstruction {
    "ff.rem".to_string()
}

pub fn powff() -> CVTInstruction {
    "ff.pow".to_string()
}
pub fn pow64() -> CVTInstruction {
    "64.pow".to_string()
}

pub fn extend_i64_ff() -> CVTInstruction {
    "ff.extend_i64".to_string()
}
pub fn wrap_ff_i64() -> CVTInstruction {
    "i64.wrap_ff".to_string()
}

pub fn load64() -> CVTInstruction {
    "i64.load".to_string()
}

pub fn loadff() -> CVTInstruction {
    "ff.load".to_string()
}

pub fn store64() -> CVTInstruction {
    "i64.store".to_string()
}

pub fn storeff() -> CVTInstruction {
    "ff.store".to_string()
}

pub fn mstore64() -> CVTInstruction {
    "i64.mstore".to_string()
}

pub fn mstoreff() -> CVTInstruction {
    "ff.mstore".to_string()
}

pub fn mstoresignalff() -> CVTInstruction {
    "ff.mstore_from_signal".to_string()
}

pub fn mstorecmpsignalff() -> CVTInstruction {
    "ff.mstore_from_cmp_signal".to_string()
}

pub fn get_signal(inx: &str) -> CVTInstruction {
    format!("get_signal {}", inx)
}

pub fn get_cmp_signal(cinx: &str, sinx: &str) -> CVTInstruction {
    format!("get_cmp_signal {} {}", cinx, sinx)
}

pub fn set_signal(inx: &str, value: &str) -> CVTInstruction {
    format!("set_signal {} {}", inx, value)
}

pub fn mset_signal(inx1: &str, inx2: &str, size: &str) -> CVTInstruction {
    format!("mset_signal {} {} {}", inx1, inx2, size)
}

pub fn mset_signal_from_memory(inx: &str, minx: &str, size: &str) -> CVTInstruction {
    format!("mset_signal_from_memory {} {} {}", inx, minx, size)
}

pub fn mset_signal_from_cmp(inx: &str, cinx: &str, sinx: &str, size: &str) -> CVTInstruction {
    format!("mset_signal_from_cmp {} {} {} {}", inx, cinx, sinx, size)
}

pub fn set_cmp_input_no_dec_no_last(cinx: &str, sinx: &str, value: &str) -> CVTInstruction {
    format!("set_cmp_input {} {} {}", cinx, sinx, value)
}
pub fn set_cmp_input_dec_no_last(cinx: &str, sinx: &str, value: &str) -> CVTInstruction {
    format!("set_cmp_input_cnt {} {} {}", cinx, sinx, value)
}
pub fn set_cmp_input_and_run(cinx: &str, sinx: &str, value: &str) -> CVTInstruction {
    format!("set_cmp_input_run {} {} {}", cinx, sinx, value)
}
pub fn set_cmp_input_dec_and_check_run(cinx: &str, sinx: &str, value: &str) -> CVTInstruction {
    format!("set_cmp_input_cnt_check {} {} {}", cinx, sinx, value)
}


pub fn mset_cmp_input_from_memory_no_dec_no_last(cinx: &str, sinx: &str, midx: &str, size: &str) -> CVTInstruction {
    format!("mset_cmp_input_from_memory {} {} {} {}", cinx, sinx, midx, size)
}
pub fn mset_cmp_input_from_memory_dec_no_last(cinx: &str, sinx: &str, midx: &str, size: &str) -> CVTInstruction {
    format!("mset_cmp_input_from_memory_cnt {} {} {} {}", cinx, sinx, midx, size)
}
pub fn mset_cmp_input_from_memory_and_run(cinx: &str, sinx: &str, midx: &str, size: &str) -> CVTInstruction {
    format!("mset_cmp_input_from_memory_run {} {} {} {}", cinx, sinx, midx, size)
}
pub fn mset_cmp_input_from_memory_dec_and_check_run(cinx: &str, sinx: &str, midx: &str, size: &str) -> CVTInstruction {
    format!("mset_cmp_input_from_memory_cnt_check {} {} {} {}", cinx, sinx, midx, size)
}

pub fn mset_cmp_input_no_dec_no_last(cinx: &str, sinx: &str, idx2: &str, size: &str) -> CVTInstruction {
    format!("mset_cmp_input {} {} {} {}", cinx, sinx, idx2, size)
}
pub fn mset_cmp_input_dec_no_last(cinx: &str, sinx: &str, idx2: &str, size: &str) -> CVTInstruction {
    format!("mset_cmp_input_cnt {} {} {} {}", cinx, sinx, idx2, size)
}
pub fn mset_cmp_input_and_run(cinx: &str, sinx: &str, idx2: &str, size: &str) -> CVTInstruction {
    format!("mset_cmp_input_run {} {} {} {}", cinx, sinx, idx2, size)
}
pub fn mset_cmp_input_dec_and_check_run(cinx: &str, sinx: &str, idx2: &str, size: &str) -> CVTInstruction {
    format!("mset_cmp_input_cnt_check {} {} {} {}", cinx, sinx, idx2, size)
}

pub fn mset_cmp_input_from_cmp_no_dec_no_last(cinx: &str, sinx: &str, cinx2: &str, sinx2: &str, size: &str) -> CVTInstruction {
    format!("mset_cmp_input_from_cmp {} {} {} {} {}", cinx, sinx, cinx2, sinx2, size)
}
pub fn mset_cmp_input_from_cmp_dec_no_last(cinx: &str, sinx: &str, cinx2: &str, sinx2: &str, size: &str) -> CVTInstruction {
    format!("mset_cmp_input_from_cmp_cnt {} {} {} {} {}", cinx, sinx, cinx2, sinx2, size)
}
pub fn mset_cmp_input_from_cmp_and_run(cinx: &str, sinx: &str, cinx2: &str, sinx2: &str, size: &str) -> CVTInstruction {
    format!("mset_cmp_input_from_cmp_run {} {} {} {} {}", cinx, sinx, cinx2, sinx2, size)
}
pub fn mset_cmp_input_from_cmp_dec_and_check_run(cinx: &str, sinx: &str, cinx2: &str, sinx2: &str, size: &str) -> CVTInstruction {
...
pub fn memory_size() -> CVTInstruction {
...
pub fn memory_grow() -> CVTInstruction {
    "memory.grow".to_string()
}
 */

pub fn shr64() -> CVTInstruction {
    "i64.shr".to_string()
}
pub fn shl64() -> CVTInstruction {
    "i64.shl".to_string()
}
pub fn shrff() -> CVTInstruction {
    "ff.shr".to_string()
}
pub fn shlff() -> CVTInstruction {
    "ff.shl".to_string()
}
pub fn call(to: &str) -> CVTInstruction {
    format!("call {}", to)
}

pub fn and64() -> CVTInstruction {
    "i64.and".to_string()
}
pub fn or64() -> CVTInstruction {
    "i64.or".to_string()
}
pub fn andff() -> CVTInstruction {
    "ff.and".to_string()
}
pub fn orff() -> CVTInstruction {
    "ff.or".to_string()
}

pub fn band64() -> CVTInstruction {
    "i64.band".to_string()
}
pub fn bor64() -> CVTInstruction {
    "i64.bor".to_string()
}
pub fn bxor64() -> CVTInstruction {
    "i64.bxor".to_string()
}
pub fn bnot64() -> CVTInstruction {
    "i64.bnot".to_string()
}
pub fn bandff() -> CVTInstruction {
    "ff.band".to_string()
}
pub fn borff() -> CVTInstruction {
    "ff.bor".to_string()
}
pub fn bxorff() -> CVTInstruction {
    "ff.bxor".to_string()
}
pub fn bnotff() -> CVTInstruction {
    "ff.bnot".to_string()
}

pub fn gt64() -> CVTInstruction {
    "i64.gt".to_string()
}
pub fn gtff() -> CVTInstruction {
    "ff.gt".to_string()
}
pub fn ge64() -> CVTInstruction {
    "i64.ge".to_string()
}
pub fn geff() -> CVTInstruction {
    "ff.ge".to_string()
}
pub fn lt64() -> CVTInstruction {
    "i64.lt".to_string()
}
pub fn ltff() -> CVTInstruction {
    "ff.lt".to_string()
}
pub fn le64() -> CVTInstruction {
    "i64.le".to_string()
}
pub fn leff() -> CVTInstruction {
    "ff.le".to_string()
}
pub fn eq64() -> CVTInstruction {
    "i64.eq".to_string()
}
pub fn eqff() -> CVTInstruction {
    "ff.eq".to_string()
}
pub fn neq64() -> CVTInstruction {
    "i64.neq".to_string()
}
pub fn neqff() -> CVTInstruction {
    "ff.neq".to_string()
}
pub fn eqz64() -> CVTInstruction {
    "i64.eqz".to_string()
}
pub fn eqzff() -> CVTInstruction {
    "ff.eqz".to_string()
}
pub fn add_loop() -> CVTInstruction {
    "loop".to_string()
}
pub fn add_break() -> CVTInstruction {
    "break".to_string()
}
pub fn add_continue() -> CVTInstruction {
    "continue".to_string()
}
pub fn br_if(value: &str) -> CVTInstruction {
    format!("br_if {}", value)
}
pub fn br(value: &str) -> CVTInstruction {
    format!("br {}", value)
}
pub fn add_if64() -> CVTInstruction {
    "i64.if".to_string()
}
pub fn add_ifff() -> CVTInstruction {
    "ff.if".to_string()
}
pub fn add_else() -> CVTInstruction {
    "else".to_string()
}
pub fn add_end() -> CVTInstruction {
    "end".to_string()
}
pub fn add_return() -> CVTInstruction {
    "return".to_string()
}

pub fn exception(code: &str) -> CVTInstruction {
    format!("error {}",code)
}
...
pub fn create_if_selection(
	...
	instructions.push(format!("{} = {} {} i64.{}", comp, eq64(), tid, values[i].0));
...
/*
pub fn get_initial_size_of_memory(producer: &CVTProducer) -> usize {
...
pub fn generate_data_constants(producer: &CVTProducer, constant_list: &Vec<String>) -> String {
...
/*
pub fn generate_data_list(producer: &CVTProducer) -> Vec<CVTInstruction> {
    let mut wdata = vec![];
    wdata.push(format!(
        "(data (i32.const {}) \"{}\")",
        0,
...
/*
pub fn reserve_stack_fr(producer: &CVTProducer, nbytes: usize) -> Vec<CVTInstruction> {
    let mut instructions = vec![];
...
pub fn reserve_stack_fr_function_generator() -> Vec<CVTInstruction> {
    let mut instructions = vec![];
...
pub fn free_stack(producer: &CVTProducer) -> Vec<CVTInstruction> {
    let mut instructions = vec![];
    instructions.push(set_constant("0"));
...
// ---------------------- functions ------------------------
/*
pub fn desp_io_subcomponent_generator(producer: &CVTProducer) -> Vec<CVTInstruction> {
    let mut instructions = vec![];
...
pub fn get_shared_rw_memory_start_generator(producer: &CVTProducer) -> Vec<CVTInstruction> {
    let mut instructions = vec![];
...
pub fn read_shared_rw_memory_generator(producer: &CVTProducer) -> Vec<CVTInstruction> {
    let mut instructions = vec![];
...
pub fn write_shared_rw_memory_generator(producer: &CVTProducer) -> Vec<CVTInstruction> {
    let mut instructions = vec![];
...
pub fn get_version_generator(producer: &CVTProducer) -> Vec<CVTInstruction> {
    let mut instructions = vec![];
...
pub fn init_generator(producer: &CVTProducer) -> Vec<CVTInstruction> {
    let mut instructions = vec![];
...
pub fn get_input_signal_map_position_generator(producer: &CVTProducer) -> Vec<CVTInstruction> {
    let mut instructions = vec![];
...
pub fn check_if_input_signal_set_generator(producer: &CVTProducer) -> Vec<CVTInstruction> {
    let mut instructions = vec![];
...
pub fn set_input_signal_generator(producer: &CVTProducer) -> Vec<CVTInstruction> {
    let mut instructions = vec![];
...
pub fn get_input_signal_size_generator(_producer: &CVTProducer) -> Vec<CVTInstruction> {
    let mut instructions = vec![];
...
pub fn get_raw_prime_generator(producer: &CVTProducer) -> Vec<CVTInstruction> {
    let mut instructions = vec![];
...
pub fn get_field_num_len32_generator(producer: &CVTProducer) -> Vec<CVTInstruction> {
    let mut instructions = vec![];
...
pub fn get_input_size_generator(producer: &CVTProducer) -> Vec<CVTInstruction> {
    let mut instructions = vec![];
...
pub fn get_witness_size_generator(producer: &CVTProducer) -> Vec<CVTInstruction> {
    let mut instructions = vec![];
...
pub fn copy_32_in_shared_rw_memory_generator(producer: &CVTProducer) -> Vec<CVTInstruction> {
    let mut instructions = vec![];
...
pub fn copy_fr_in_shared_rw_memory_generator(producer: &CVTProducer) -> Vec<CVTInstruction> {
    let mut instructions = vec![];
...
pub fn get_witness_generator(producer: &CVTProducer) -> Vec<CVTInstruction> {
    let mut instructions = vec![];
...
pub fn get_message_char_generator(producer: &CVTProducer) -> Vec<CVTInstruction> {
    let mut instructions = vec![];
...
pub fn build_log_message_generator(producer: &CVTProducer) -> Vec<CVTInstruction> {
    let mut instructions = vec![];
...
pub fn build_buffer_message_generator(producer: &CVTProducer) -> Vec<CVTInstruction> {
    let mut instructions = vec![];
...
pub fn generate_table_of_template_runs(producer: &CVTProducer) -> Vec<CVTInstruction> {
    let mut instructions = vec![];
...
fn get_file_instructions(name: &str) -> Vec<CVTInstruction> {
...
pub fn fr_types(prime: &String) -> Vec<CVTInstruction> {

    // TODO
    Vec::new()
}

pub fn fr_data(prime: &String) -> Vec<CVTInstruction> {
    // TODO
    Vec::new()
}
pub fn fr_code(prime: &String) -> Vec<CVTInstruction> {
    // TODO
    Vec::new()
}
*/
...
mod tests {
    ...
    fn create_producer() -> CVTProducer {
        CVTProducer::default()
    }
    ...
    */
    fn write_block(writer: &mut BufWriter<File>, code: Vec<CVTInstruction>) {
...
pub fn generate_prime(producer: &CVTProducer)-> Vec<CVTInstruction>{
...
pub fn generate_signals_memory(producer: &CVTProducer) -> Vec<CVTInstruction>{
    let mut instr = Vec::new();
...
pub fn generate_components_heap(producer: &CVTProducer)-> Vec<CVTInstruction>{
    let mut instr = Vec::new();
...
pub fn generate_types(producer: &CVTProducer) -> Vec<CVTInstruction>{
    let mut instr = Vec::new();
    ...
    for bus in producer.get_busid_field_info(){
        instr.push(format!("%%type bus_{}", node_id + 1));
        for field in bus{
            // We store the following info: name type number_dims dims
            instr.push(format!("       {} {}",
                field.name,
                declare_variable(field.bus_id, &field.dimensions)
            ));
...
pub fn generate_main_template(producer: &CVTProducer) -> Vec<CVTInstruction>{
    let mut instr = Vec::new();
...
pub fn generate_components(producer: &CVTProducer) -> Vec<CVTInstruction>{
    let mut instr = Vec::new();
...
pub fn generate_witness(producer: &CVTProducer) -> Vec<CVTInstruction>{
    let mut instr = Vec::new();
...
pub fn generate_input_signals(producer: &CVTProducer) -> Vec<CVTInstruction>{
    let mut instr = Vec::new();
    let mut aux = Vec::new();
    let mut n_inputs = 0;
